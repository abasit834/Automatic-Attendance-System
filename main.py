...
class Automatic_Attendance_System:
    def __init__(self, root):
        ...
        img0 = Image.open(r"AMS.jpeg")
        img0 = img0.resize((1530, 790))  # Resize the image to fit window
        self.photoimg = ImageTk.PhotoImage(img0)
        ...
        b2= Button(bg_img,image=self.photoimg2,command=self.faceRecognitionScreen,cursor="hand2")
        b2.place(x=500,y=100,width=220,height=220) 

        
        b2= Button(bg_img,text="Face Detector",command=self.faceRecognitionScreen,cursor="hand2",font=("times new roman", 15, "bold"), bg="light blue", fg="black")
        ...
        b3= Button(bg_img,text="Attendance",cursor="hand2",font=("times new roman", 15, "bold"), bg="light blue", fg="black")
        ...
        b4= Button(bg_img,text="Help Desk",cursor="hand2",font=("times new roman", 15, "bold"), bg="light blue", fg="black")
        ...
        b5= Button(bg_img,image=self.photoimg5,command=self.trainData,cursor="hand2")
        b5.place(x=200,y=380,width=220,height=220) 

        
        b5= Button(bg_img,text="Train Data",command=self.trainData,cursor="hand2",font=("times new roman", 15, "bold"), bg="light blue", fg="black")
        ...
        b6= Button(bg_img,text="Photos",command=self.open_img,cursor="hand2",font=("times new roman", 15, "bold"), bg="light blue", fg="black")
        ...
        b8= Button(bg_img,text="Developer",cursor="hand2",font=("times new roman", 15, "bold"), bg="light blue", fg="black")
        b8.place(x=800,y=580,width=220,height=40) 
        ...
        b9= Button(bg_img,image=self.photoimg8,cursor="hand2")
        b9.place(x=1100,y=380,width=220,height=220) 

        
        b9= Button(bg_img,text="Exit",cursor="hand2",font=("times new roman", 15, "bold"), bg="light blue", fg="black")
        b9.place(x=1100,y=580,width=220,height=40) 
